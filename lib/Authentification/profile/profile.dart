...
import '/Authentification/profile/constants.dart';
import '/Authentification/profile/widgets/profile_list_item.dart';
import '/Authentification/screens/UserLinking.dart';
import '/Authentification/screens/User.dart';
import 'package:provider/provider.dart';
import '/Authentification/profile/profileInfo.dart';
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) =>  MyProfilePage(title: 'Profile Page'))); // Navigation vers MyProfilePage
            },
